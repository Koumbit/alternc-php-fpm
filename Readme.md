...
Ondrej provides us with all versions of php (from 5.6 to 8.4) for all current versions of debian (from oldoldstable to testing)
...
apt install php8.4-fpm php8.4-mysql php8.4-common
